    ...
    if(GLSL_VALIDATOR)
        ...
        foreach(GLSL_FILE ${GLSL_FILES})
            ...
            add_custom_target(
                ...
                COMMAND ${GLSL_VALIDATOR} -V ${GLSL_FILE} -o ${SPIRV_FILE} -e main -t --enhanced-msgs --target-env ${TARGET_ENV} -I${SHADER_DIR} --spirv-val
            )

            add_custom_target(
                ${GLSL_FILENAME}_SPIRV_C_TARGET
                COMMAND ${GLSL_VALIDATOR} -V ${GLSL_FILE} -o ${SPIRV_C_HEADER_FILE} -e main -t --enhanced-msgs --target-env ${TARGET_ENV} -I${SHADER_DIR} --vn ${SPIRV_C_NAME} --spirv-val
            )
